#include "InfiniteLoop_checker.h"
...
static const char* const RULE_KEY = "infinite loop1";
static const char* const ISSUE_DESC = "The checker finds instances of loops that have no exit.";




ADDTO_GAMMA_RULE_FACTORY_CTOR(RULE_KEY, InfiniteLoopChecker)


void InfiniteLoopChecker::onEndOfTranslationUnit(clang::ASTContext& pContext, InfiniteLoopVisitor& pVisitor, std::vector<GammaASTBean>& pAstBeans)
{
